export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: 'Import will create new accounts/proxies. If groups are selected, new accounts are bound during import. Ensure existing data does not conflict.',
      dataImportFile: 'Data file',
      dataImportFileCount: '{count} files selected',
      dataImportGroups: 'Import groups',
      dataImportGroupsHint: 'Optional. Selected groups are bound to newly imported accounts; leave empty to avoid binding default groups.',
