export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: '导入将创建新账号与代理；如选择分组，新账号会在导入时直接绑定。请确认已有数据不会冲突。',
      dataImportFile: '数据文件',
      dataImportFileCount: '已选择 {count} 个文件',
      dataImportGroups: '导入分组',
      dataImportGroupsHint: '可选。选择后，本次导入的新账号会直接绑定到这些分组；不选则不绑定默认分组。',
